...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul class="">
            <a href="" class="nav_link sublink"><i class="fa-solid fa-house"></i>Dashboard</a>

        </ul>

        <ul class="">
            <a href="" class="nav_link sublink"><i class="fa-solid fa-arrow-down-1-9"></i>Halaman Pertama</a>

        </ul>


        <ul class="">
            <a href="" class="nav_link sublink"><i class="fa-solid fa-arrow-down-9-1"></i>Halaman Kedua</a>
